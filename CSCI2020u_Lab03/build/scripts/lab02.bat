...
set CLASSPATH=%APP_HOME%\lib\lab02.jar;%APP_HOME%\lib\commons-csv-1.4.jar

@rem Execute lab02
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB02_OPTS%  -classpath "%CLASSPATH%" ./src/main/java/csci2020u/lab02/SimpleTest.java %CMD_LINE_ARGS%
